...
contextBridge.exposeInMainWorld('api', {
  ...
  restoreAccountData: (id, force) => ipcRenderer.invoke('restore-account-data', { id, force }),
  ...
  deleteAccountData:  (id)    => ipcRenderer.invoke('delete-account-data', id),
  revealCredential:   (id)    => ipcRenderer.invoke('reveal-credential', id),
